...
function DepartmentButtonComponent({ dept, isActive, icon: Icon, palette, darkMode, onClick }: DepartmentButtonProps) {
  return (
    <button
      onClick={onClick}
      className={cx(
        "group w-full text-left px-5 py-3.5 rounded-xl text-sm flex items-center gap-3.5 transition-[transform,box-shadow,background-color] duration-300 font-medium",
        isActive
